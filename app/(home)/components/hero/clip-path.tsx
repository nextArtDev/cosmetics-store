      ...
      <svg width="0" height="0" className="absolute">
        <defs>
          <clipPath id="differentone23" clipPathUnits="objectBoundingBox">
            ...
            <path d="M0.679,0.066 H0.914 C0.914,0.066,0.998,0.066,0.998,0.159 V0.913 C0.998,0.992,0.998,0.998,0.893,0.998 H0.549 C0.5,0.998,0.5,0.979,0.5,0.932 C0.5,0.884,0.448,0.884,0.448,0.884 H0.114 C0.052,0.884,0.002,0.884,0.002,0.768 V0.159 C0.002,0.076,0.054,0.086,0.114,0.086 H0.170 C0.239,0.086,0.168,0.002,0.285,0.002 H0.572 C0.683,0.002,0.630,0.066,0.679,0.066 Z" />
          </clipPath>
        </defs>
      </svg>
